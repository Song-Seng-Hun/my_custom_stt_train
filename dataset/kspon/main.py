...
def _get_parser():
    ...
    parser.add_argument('--dataset_path', type=str,
                        default='D:/workspace/model/my_custom_stt_train/data/kspon/pcm',
                        help='path of original dataset')
    parser.add_argument('--vocab_dest', type=str,
                        default='D:/workspace/model/my_custom_stt_train/data/vocab',
    ...
    parser.add_argument('--savepath', type=str,
                        default='D:/workspace/model/my_custom_stt_train/data/save',
                        help='path of data')
