...
DATASET_PATH="D:\\workspace\\model\\my_custom_stt_train\\data\\kspon"
VOCAB_DEST="D:\\workspace\\model\\my_custom_stt_train\\data\\kspon\\vocab"
OUTPUT_UNIT='character'                                          # you can set character / subword / grapheme
PREPROCESS_MODE='phonetic'                                       # phonetic : 칠 십 퍼센트,  spelling : 70%
VOCAB_SIZE=1617                                                  # if you use subword output unit, set vocab size
