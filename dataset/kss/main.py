...
def _get_parser():
    ...
    parser.add_argument('--dataset_path', type=str,
                        default='D:/workspace/model/my_custom_sst_train/data/archive/kss',
                        help='path of original dataset')
    parser.add_argument('--vocab_dest', type=str,
                        default='D:/workspace/model/my_custom_sst_train/data/vocab',
    ...
    parser.add_argument('--savepath', type=str,
                        default='D:/workspace/model/my_custom_sst_train/data/save',
                        help='path of data')
...
def main():
    ...
    audio_paths, transcripts = preprocess(
        opt.dataset_path, opt.preprocess_mode)
    ...
    if opt.output_unit == 'character':
        ...
        raise ValueError(
            "Unsupported preprocess method : {0}".format(opt.output_unit))
